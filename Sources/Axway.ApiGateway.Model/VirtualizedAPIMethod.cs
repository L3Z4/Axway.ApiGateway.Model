...
{
    /// <summary>Represents a virtualized API method as part of a frontend API.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "9.7.3.0 (Newtonsoft.Json v9.0.0.0)")]
    public partial class VirtualizedAPIMethod
    {
        ...
        public static VirtualizedAPIMethod FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<VirtualizedAPIMethod>(data);
        }
    }
}